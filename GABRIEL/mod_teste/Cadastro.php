					...
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8 col-md-12">
							...
							<p class="pt-10 pb-10 text-white">
								Esta aplicação traz uma interação mais proxima entre orientador e aluno
							</p>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.11/jquery.mask.min.js"></script>
								...
								<input type="text" class="form-control" name="txttel" placeholder="Telefone" id="telefone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Telefone'" >

								<input type="text" class="form-control" name="txtcel" placeholder="Celular" maxlength="11" id="telefone" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Celular'" >
								...
								<input type="text" class="form-control" name="txtend" placeholder="Endereço" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Endereço'" >
														...
														if($login == "" || $login == null || $login == "RM"){
															...
															alert('Por favor insira o seu RM');
															</script>";
														}
