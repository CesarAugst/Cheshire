                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-sm-6 col-8 header-top-right">
                            <a href="Cadastro.php" class="primary-btn text-uppercase">Cadastra-se</a>
                        </div>
                    </div>			  					
                </div>
            </div>
            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="Inicio.php">Inicio </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.php"> Contato</a></p>
                    </div>	
                </div>
            </div>
        </section>
