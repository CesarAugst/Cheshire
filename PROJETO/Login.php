			...
			<footer class="footer-area section-gap">
				<div class="container">
					...
					<div class="row footer-bottom d-flex justify-content-between">
						<p class="col-lg-5 col-sm-05 footer-text m-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Etec de Cotia | Centro Paulo Souza <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href=" http://www.etecdecotia.com.br/" target="_blank">Etec</a>
