...
<body>
	...
	<section class="sample-text-area">
		<center>
			<h1 class="text-black">O que é um transtorno emocional?</h1>
			...
			<div class="section-top-border">
				...
				<div class="row">
					...
					<div class="col-md-9 mt-sm-20 left-align-p ">
						<p class="text-justify">Quando na medida certa, a ansiedade é positiva para o ser humano, pois age liberando uma série de hormônios capazes de nos tornar mais alertas e ativos diante dos desafios.
						</p>
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="visit text-black">6.3%/48.457.102</div>
						...
						<div class="table-row">
							...
							<div class="visit text-black">6.1%/24.621.009</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="visit text-black">6.0%/327.822.431</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="visit text-black">5.9%/209.351.024</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="visit text-black">5.7%/10.291.056</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="visit text-black">5.6/2.794.023</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="visit text-black">5.4%/4.794.079</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="visit text-black">5.4%/3.551.004</div>
							<div class="percentage">
								<div class="progress">
						...
						<a href="https://saude.estadao.com.br/galerias/geral,os-15-paises-com-maiores-taxas-de-depressao-do-mundo,30422">
							<dd>fonte/https://saude.estadao.com.br/galerias/geral,os-15-paises-com-maiores-taxas-de-depressao-do-mundo,30422</dd>
					</div>
				</div>
			</div>
		</div>
