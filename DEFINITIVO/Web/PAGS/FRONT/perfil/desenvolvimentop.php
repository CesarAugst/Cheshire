        ...
        <div class="row align-items-top">
            <div class="col-sm-2 border-right"><br>
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link text-dark bg-success border rounded" href="desenvolvimentop.php">Desenvolvimento</a>
            ...
            <div class="col-8"><br>
                ...
                <h5 class="bg-light border rounded nav-link">
                    Locomoção: <?= desenvolvimento($conexao, $_SESSION['rmp'])['locomocao'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Fala: <?= desenvolvimento($conexao, $_SESSION['rmp'])['fala'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Visão: <?= desenvolvimento($conexao, $_SESSION['rmp'])['visao'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Audição: <?= desenvolvimento($conexao, $_SESSION['rmp'])['audicao'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Atenção: <?= desenvolvimento($conexao, $_SESSION['rmp'])['atencao'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Anciosidade: <?= desenvolvimento($conexao, $_SESSION['rmp'])['anciosidade'] ?><br>
                </h5>
            </div>
        </div>
