        ...
        <div class="row align-items-top">
            <div class="col-sm-2 border-right"><br>
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link text-dark bg-success border rounded" href="saudep.php">Saúde</a>
            ...
            <div class="col-8"><br>
                ...
                <h5 class="bg-light border rounded nav-link">
                    Cuidados medicos: <?= saude($conexao, $_SESSION['rmp'])['cuidados_medicos'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Alergias: <?= saude($conexao, $_SESSION['rmp'])['alergias'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Medicação: <?= saude($conexao, $_SESSION['rmp'])['medicacao'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    pode praticar Ed. Física: <?= saude($conexao, $_SESSION['rmp'])['ed_fisica'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Acidente: <?= saude($conexao, $_SESSION['rmp'])['acidente'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Cirurgia: <?= saude($conexao, $_SESSION['rmp'])['cirurgia'] ?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Convulções: <?= saude($conexao, $_SESSION['rmp'])['convulcoes'] ?>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Problemas neurológicos: <?= saude($conexao, $_SESSION['rmp'])['problemas_neurologicos'] ?>
                </h5>
            </div>
        </div>
