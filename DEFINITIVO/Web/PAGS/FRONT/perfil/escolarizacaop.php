        ...
        <div class="row align-items-top">
            <div class="col-sm-2 border-right"><br>
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link text-dark bg-success border rounded" href="escolarizacaop.php">Escolarização</a>
                </nav>
            </div>
            <div class="col-8"><br>
                ...
                <h5 class="bg-light border rounded nav-link">
                    Escola Anterior: <?= escolarizacao($conexao, $_SESSION['rmp'])['escola_anterior']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Relacionamento c/ Professores: <?= escolarizacao($conexao, $_SESSION['rmp'])['relacionamento_professores']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Relacionamento c/ Colegas: <?= escolarizacao($conexao, $_SESSION['rmp'])['relacionamento_colegas']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Dificuldades de Aprendizagem: <?= escolarizacao($conexao, $_SESSION['rmp'])['dificuldade_aprendizagem']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Apoio pedagogico: <?= escolarizacao($conexao, $_SESSION['rmp'])['apoio_pedagogico']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Avaliação Profissional: <?= escolarizacao($conexao, $_SESSION['rmp'])['avaliacao_profissional']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Acompanhamento Profissional: <?= escolarizacao($conexao, $_SESSION['rmp'])['acompanhamento_profissional']?><br>
                </h5>
                <h5 class="bg-light border rounded nav-link">
                    Necessita Apoio: <?= escolarizacao($conexao, $_SESSION['rmp'])['necessita_apoio']?><br>
                </h5>
            </div>
        </div>
