<!DOCTYPE html>
	...
	<body>
		<header id="header">
			...
			<div class="container main-menu">
				<div class="row align-items-center justify-content-between d-flex">
					<div id="logo">
						<a href="pagIndex.html"><img src="../../img/logo.png" alt="" title="" /></a>
					</div>
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							<li><a href="pagIndex.html">Home</a></li>
							<li><a href="pagAbout.html">About</a></li>
							<li><a href="pagFeatures.html">Features</a></li>
							<li><a href="pagDoctors.html">Doctors</a></li>
							<li><a href="pagDepartments.html">Departments</a></li>
							<li class="menu-has-children"><a href="">Blog</a>
								<ul>
									<li><a href="pabBlog-home.html">Blog Home</a></li>
									<li><a href="pagBlog-single.html">Blog Single</a></li>
								</ul>
							</li>
							<li class="menu-has-children"><a href="">Pages</a>
								<ul>
									<li><a href="pagElements.html">Elements</a></li>
							...
							<li><a href="pagContact.html">Contact</a></li>
						</ul>
			...
			<div class="container">
				<div class="row d-flex align-items-center justify-content-center">
					<div class="about-content col-lg-12">
						...
						<p class="text-white link-nav"><a href="pagIndex.html">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="features.html"> Features</a></p>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="facilities-area section-gap">
			<!-- Aqui fica o chat -->
			<h1>Para enviar uma mensagem de <?php echo $_SESSION['nome'] ?></h1><br>
